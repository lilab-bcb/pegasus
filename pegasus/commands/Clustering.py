...
Options:
  ...
  --plot-wordcloud                                 Plot word cloud plots of feature weights in gene programs generated by NMF or iNMF. This option will be ignored if neither NMF nor iNMF is enabled.
  ...
  pegasus cluster -p 20 --leiden --umap --net-fle example.zarr.zip example_out
    ...
    def execute(self):
        kwargs = {
            ...
            "plot_wordcloud": self.args["--plot-wordcloud"],
