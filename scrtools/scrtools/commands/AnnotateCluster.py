...
Options:
  --json-file <file>                    JSON file for markers. Could also be human_immune/mouse_immune/mouse_brain/human_brain, which triggers scrtools to markers included in the package. [default: human_immune]
