...
Examples:
  scrtools view --show-attributes manton_bm.h5ad
  scrtools view --show-gene-attributes manton_bm.h5ad
  scrtools view --show-values-for-attributes louvain_labels,Condition manton_bm.h5ad
    """
