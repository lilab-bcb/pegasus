...
Options:
  ...
  --restriction <restriction>...     Set restriction if you only want to plot a subset of data. Multiple <restriction> strings are allowed. Each <restriction> takes the format of 'attr:value,value' or 'attr:~value,value..", which means exclude values. This option is used in 'composition' and 'scatter'.
