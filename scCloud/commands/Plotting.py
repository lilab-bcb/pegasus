...
Usage:
  scCloud plot [options] [--restriction <restriction>scCloud..] <plot_type> <input_h5ad_file> <output_file>
  scCloud plot -h
...
Options:
  ...
  --restriction <restriction>scCloud..     Set restriction if you only want to plot a subset of data. Multiple <restriction> strings are allowed. Each <restriction> takes the format of 'attr:value,value'. This option is used in 'composition' and 'scatter'.
